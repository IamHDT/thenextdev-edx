...
if settings.FEATURES.get('ENABLE_SYSADMIN_DASHBOARD') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
...
if settings.FEATURES.get('ENABLE_VIEWS'):
    # pylint: disable=invalid-name
    favicon_path = configuration_helpers.get_value('favicon_path', settings.FAVICON_PATH)
    urlpatterns += [
...
if settings.WIKI_ENABLED and settings.FEATURES.get('ENABLE_VIEWS'):
...
if settings.FEATURES.get('ENABLE_MASQUERADE') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
        url(
...
if settings.FEATURES.get('ENABLE_STUDENT_HISTORY_VIEW') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
        url(
...
if settings.FEATURES.get('CLASS_DASHBOARD') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
...
if settings.FEATURES.get('AUTH_USE_OPENID') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
...
if settings.FEATURES.get('AUTH_USE_SHIB') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
        url(r'^shib-login/$', external_auth_views.shib_login, name='shib-login'),
    ]

if settings.FEATURES.get('AUTH_USE_CAS') and settings.FEATURES.get('ENABLE_VIEWS'):
...
if settings.FEATURES.get('RESTRICT_ENROLL_BY_REG_METHOD') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
...
if settings.FEATURES.get('AUTH_USE_OPENID_PROVIDER') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
        url(
...
if settings.FEATURES.get('ENABLE_SQL_TRACKING_LOGS') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
        url(r'^event_logs$', track_views.view_tracking_log),
        url(r'^event_logs/(?P<args>.+)$', track_views.view_tracking_log),
    ]

if settings.FEATURES.get('ENABLE_SERVICE_STATUS') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
        url(r'^status/', include('openedx.core.djangoapps.service_status.urls')),
    ]

if settings.FEATURES.get('ENABLE_INSTRUCTOR_BACKGROUND_TASKS') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
        url(
...
if settings.FEATURES.get('RUN_AS_ANALYTICS_SERVER_ENABLED') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
        url(r'^edinsights_service/', include('edinsights.core.urls')),
    ]

if settings.FEATURES.get('ENABLE_DEBUG_RUN_PYTHON') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
...
if settings.FEATURES.get('ENABLE_LTI_PROVIDER') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
...
if settings.FEATURES.get('ENABLE_FINANCIAL_ASSISTANCE_FORM') and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
        url(
...
if settings.BRANCH_IO_KEY and settings.FEATURES.get('ENABLE_VIEWS'):
    urlpatterns += [
